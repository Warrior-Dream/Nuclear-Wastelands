...
gs-balanceui-shop-label = Магазин Воителя
...
gs-balanceui-shop-buy-token-hightier-antag = Купить хайтир антаг токен - { $price } Коинов
gs-balanceui-shop-buy-token-midtier-antag = Купить мидтир антаг токен - { $price } Коинов
gs-balanceui-shop-buy-token-admin = Купить должность младшего игрового модератора - { $price } Коинов
gs-balanceui-shop-buy-token-antag = Купить антаг токен - { $price } Коинов
gs-balanceui-shop-buy-token-lowtier-antag = Купить лоутир - { $price } Коинов
...
gs-balanceui-shop-buy-token-admin-abuse = Купить админ абуз токен - { $price } Коинов
...
gs-balanceui-shop-buy-token-ghost = Купить гостроль токен - { $price } Коинов
